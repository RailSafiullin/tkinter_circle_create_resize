[![ CI](https://github.com/RailSafiullin/tkinter_circle_create_resize/actions/workflows/app.yml/badge.svg)](https://github.com/RailSafiullin/tkinter_circle_create_resize/actions/workflows/python-app.yml)
